...
*********************************************************************************************************
*/
static void bsp_key_GPIOConfig(void)
{
	GPIO_InitTypeDef GPIO_InitStructure;
	
	bsp_rcc_GPIOClcokCmd(KEY_UP_PORT);
	bsp_rcc_GPIOClcokCmd(KEY_OK_PORT);
	bsp_rcc_GPIOClcokCmd(KEY_DOWN_PORT);
...
*********************************************************************************************************
*/
static void bsp_key_FifoConfig(void)
{
	uint8_t i = 0;
